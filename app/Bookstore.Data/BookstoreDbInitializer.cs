...
{
    // TODO: Migrate to EF Core seeding pattern using HasData or a seeding service
    // EF Core doesn't have DropCreateDatabaseIfModelChanges - use migrations instead
    /*
